...
لإنشاء أول حساب مالك على الإنتاج مرة واحدة فقط (تفاعلي، بدون كلمة مرور في سطر
الأوامر، ويرفض التنفيذ إن وُجد مالك مسبقاً):
...
لا تسجّل الأمر مع قيمة الرابط في Git أو المحادثة. امسح متغير البيئة بعد الانتهاء.
